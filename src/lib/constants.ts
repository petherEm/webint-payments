    ...
    symbolsGroups: [
        {
            name: 'Financial',
            symbols: [
                { name: 'NYSE:WU', displayName: 'Western Union Co' },
                ...
                { name: 'NYSE:GS', displayName: 'Goldman Sachs Group' },
                { name: 'NYSE:AXP', displayName: 'American Express Co' },
                { name: 'NYSE:PNC', displayName: 'Pnc Financial Services' },
